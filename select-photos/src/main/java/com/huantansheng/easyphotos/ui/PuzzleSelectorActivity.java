...
import com.druid.locallan.LocalLanManager;
...
public class PuzzleSelectorActivity extends AppCompatActivity implements View.OnClickListener, AlbumItemsAdapter.OnClickListener, PuzzleSelectorAdapter.OnClickListener, PuzzleSelectorPreviewAdapter.OnClickListener {
    ...
    protected void attachBaseContext(Context base) {
        super.attachBaseContext(LocalLanManager.attachBaseContext(base));
    }
...
//        albumModel.query(this, null);
    ...
    public void onClick(View view) {
        ...
        if (R.id.iv_back == id) {
            ...
            PuzzleActivity.startWithPhotos(this, selectedPhotos, Environment.getExternalStorageDirectory().getAbsolutePath() + "/" +
                   getPackageName(), "IMG", Code.REQUEST_PUZZLE, false, Setting.imageEngine);
